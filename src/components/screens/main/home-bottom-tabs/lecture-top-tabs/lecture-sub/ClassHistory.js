...
const ClassHistory = ({ route }) => {
  const { title } = route.params;

  const [topicsLesson1, setTopicsLesson1] = useState([
    { title: 'Introduction to History', duration: '2:00', unlocked: true, completed: false },
    { title: 'Ancient Civilizations', duration: '4:00', unlocked: false, completed: false },
    { title: 'Middle Ages', duration: '3:30', unlocked: false, completed: false },
    { title: 'Modern History', duration: '5:00', unlocked: false, completed: false },
    { title: 'World Wars', duration: '6:00', unlocked: false, completed: false },
  ]);

  const [topicsLesson2, setTopicsLesson2] = useState([
    { title: 'Cold War', duration: '5:00', unlocked: false, completed: false },
    { title: 'Post-Cold War Era', duration: '4:30', unlocked: false, completed: false },
    { title: 'History of Technology', duration: '4:30', unlocked: false, completed: false },
    { title: 'Globalization', duration: '6:00', unlocked: false, completed: false },
    { title: 'Conclusion', duration: '5:00', unlocked: false, completed: false },
  ]);
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.textContainer}>
        <Text style={styles.introductionText}>Introduction to History</Text>
