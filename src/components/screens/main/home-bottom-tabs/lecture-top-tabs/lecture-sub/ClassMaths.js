...
const ClassMaths = ({ route }) => {
  const { title } = route.params;

  const [topicsLesson1, setTopicsLesson1] = useState([
    { title: 'Introduction', duration: '2:05', unlocked: true, completed: false },
    { title: 'Fundamentals of Algebra', duration: '3:30', unlocked: false, completed: false },
    { title: 'Basic Arithmetic', duration: '1:50', unlocked: false, completed: false },
    { title: 'Geometry Basics', duration: '4:10', unlocked: false, completed: false },
    { title: 'Advanced Calculus', duration: '5:00', unlocked: false, completed: false },
  ]);

  const [topicsLesson2, setTopicsLesson2] = useState([
    { title: 'Linear Equations', duration: '3:10', unlocked: false, completed: false },
    { title: 'Polynomials', duration: '2:40', unlocked: false, completed: false },
    { title: 'Quadratic Functions', duration: '4:15', unlocked: false, completed: false },
    { title: 'Trigonometry Basics', duration: '3:30', unlocked: false, completed: false },
    { title: 'Integral Calculus', duration: '5:20', unlocked: false, completed: false },
  ]);
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.textContainer}>
        <View style={styles.texts}>
          ...
          <Text style={styles.fundamentalsText}>Fundamentals of Maths</Text>
        </View>
