...
const ClassEditing = ({ route }) => {
  const { title } = route.params;

  const [topicsLesson1, setTopicsLesson1] = useState([
    { title: 'Introduction to Editing', duration: '2:30', unlocked: true, completed: false },
    { title: 'Basic Tools', duration: '3:30', unlocked: false, completed: false },
    { title: 'Layer Management', duration: '4:00', unlocked: false, completed: false },
    { title: 'Color Grading', duration: '5:00', unlocked: false, completed: false },
    { title: 'Effects and Transitions', duration: '5:30', unlocked: false, completed: false },
  ]);
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.textContainer}>
        <Text style={styles.introductionText}>Introduction to Editing</Text>
